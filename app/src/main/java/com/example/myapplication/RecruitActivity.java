...
public class RecruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //날짜 지정
        date_view.setText(getTime());
        //시간 ID 가져오기
        time = findViewById(R.id.date_view2);
    ...
    private void save_boarddata(Board board){
        ...
        board.setTime(time.getText().toString()); //시간 저장
            ...
            result -> {
                ...
                //성공적으로 값을 받아왔는지 확인
                 if(result.getResultCode()==RESULT_OK){
                     ...
                     time.setText(result.getData().getStringExtra("time"));
                 }
            }
    );
}
